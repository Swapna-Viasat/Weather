...
public class WeatherArrayAdapter extends ArrayAdapter<Weather> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        WeatherArrayAdapter.ViewHolder viewHolder; // object that reference's list item's views
        ...
        if (convertView == null) { // no reusable ViewHolder, so create one
            viewHolder = new WeatherArrayAdapter.ViewHolder();
            ...
            viewHolder = (WeatherArrayAdapter.ViewHolder) convertView.getTag();
        }
//download icon in a seperate thread
        new WeatherArrayAdapter.LoadImageTask(viewHolder.conditionImageView).execute(day.iconURL);
